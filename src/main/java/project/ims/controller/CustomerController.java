...
//        System.out.println("................ "+cdao.getByID(id).getCustomerId());
	...
	@RequestMapping (value="/customer/customeradminedit/{id}")
	...
	@RequestMapping (value="/customer/customeradminedit1/{id}" )
	...
	@RequestMapping (value="/customer/customeradminedit0/{id}")
