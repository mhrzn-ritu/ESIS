        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 hidden-sm hidden-xs">
                    <a href="/index"><img src="/public/customer/images/logo.png" height="70"></a>
                </div>
    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="image_left">
                        <img src="${productinfo.productImage}" name = "productinfo" height="400" width="300">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="details-center">
                        ...
                        <p>Quantity:
                            <form:form method="POST" action="/addtocart/${productinfo.productId}">
                                <form:select path="${cart.quantity}" name="quantity">
                                ...
                                <div class="cart_btn">
                                    <c:choose>
                                        <c:when test="${empty loggedIn.username}">
                                            <a href="/login" class="btnnew btn-primary btn-sm"> Add to Cart </a>
                                        </c:when>
                                        <c:otherwise>
                                            <form:button type="submit" class="btnnew btn-primary btn-sm"> Add to Cart </form:button>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </form:form>
                        ...
                        <li>Share Product:</li>
                            <li>
                                <a href="http://facebook.com/" class="share_product"><i class="fa fa-facebook-official grow"></i></a>
                            </li>
                            <li>
                                <a href="http://instagram.com/" class="share_product"><i class="fa fa-instagram grow"></i></a>
                            </li>
                            <li>
                                <a href="http://google.com/" class="share_product"><i class="fa fa-pinterest-p grow"></i></a>
                            </li>
                            <li>
                                <a href="http://twitter.com/" class="share_product"><i class="fa fa-twitter grow"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="description_block">
                ...
                <p class="">${productinfo.productDescription}</p>
            </div>

            <div class="similar_product">
                <h4 class="lead"> Similar Products </h4><br>
                <c:forEach var="filename" items="${productall}">
                    <c:choose>
                        <c:when test="${productinfo.categoryId.parentId.categoryId == filename.categoryId.parentId.categoryId}" >
                            <c:choose>
                                <c:when test="${productinfo.productId == filename.productId}">
        ...
        <div class="col-md-2">
            ...
            <div class="details-right">
                ...
                <div class="link-box list-group list-unstyled">
                    ...
                    <c:forEach var="brand" items="${brandinfo}">
                        <li>
                ...
                <%--SUPPLIER--%>
                <div class="link-box list-group list-unstyled">
                    <h5 class="link-box-header list-group-item">Suppiler</h5>
